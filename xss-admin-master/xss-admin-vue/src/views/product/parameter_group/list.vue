<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link :to="'/product/parameter_group/add'">
    ...
    <el-table ref="multipleTable" :data="list" v-loading="listLoading" fit tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" @sort-change='sortChange'>
      ...
      <el-table-column align="center" label="操作" width="120">
        <template slot-scope="scope">
          <router-link :to="'/product/parameter_group/edit/'+scope.row.id">
...
<script>
  ...
  import { fetchList,remove } from '@/api/parameterGroup'

  export default {
    name: 'parameterGroupTable',
    directives: {
      waves
    },
    data() {
