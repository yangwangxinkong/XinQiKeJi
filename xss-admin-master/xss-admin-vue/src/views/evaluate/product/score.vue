      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="评分人数：">
            {{productInfo?productInfo.scoreCount:0}}
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="评分平均数：">
            {{productInfo?productInfo.score:0}}
          </el-form-item>
        </el-col>
      </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getScoreList() {
        this.listLoading = true
        var searchData={"pageable":this.listQuery,"scoreSearch":{"type":"product","objId":this.id}};
