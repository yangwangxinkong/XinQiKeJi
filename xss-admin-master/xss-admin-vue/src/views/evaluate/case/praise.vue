  ...
  <div class="app-container">
    <el-form class="form-container" label-width="120px" :model="companyCaseInfo">
      ...
      <el-form-item label="点赞人数：">
        <el-col :span="15">
         {{companyCaseInfo?companyCaseInfo.praiseNum:0}}
        </el-col>
      </el-form-item>
      </div>
    </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getPraiseList() {
        this.listLoading = true
        var searchData={"pageable":this.listQuery,"praiseSearch":{"type":"company_case","objId":this.id}};
