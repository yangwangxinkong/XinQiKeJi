  ...
  <div class="app-container">
    <el-form class="form-container" label-width="120px" :model="companyCaseInfo">
      ...
      <el-form-item label="评论人数：">
        <el-col :span="15">
         {{companyCaseInfo?companyCaseInfo.commentNum:0}}
        </el-col>
      </el-form-item>
      </div>
    </el-form>
    ...
    methods: {
      getCompany() {
        ...
        info({id:this.id}).then(response => {
          ...
          console.log(this.companyCaseInfo);
          setTimeout(() => {
      ...
      getCommentList() {
        this.listLoading = true
        var searchData={"pageable":this.listQuery,"commentSearch":{"type":"company_case","objId":this.id}};
