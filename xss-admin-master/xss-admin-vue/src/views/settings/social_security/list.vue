<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <!-- <el-select v-model="listQuery.accountPropertyId" clearable :placeholder="$t('settings.accountPropertySelect')" class="filter-item">
        <el-option
          v-for="item in accountPropertyList"
          :key="item.value"
          :label="item.desc"
          :value="item.value">
        </el-option>
      ...
      <el-select v-model="listQuery.socialSecurityCategoryId" clearable :placeholder="$t('settings.socialSecurityCategorySelect')" class="filter-item">
        <el-option
      ...
      <router-link :to="'/settings/social_Security/add'">
    ...
    <el-table ref="multipleTable" :data="list" v-loading="listLoading" fit tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" @sort-change='sortChange'>
      ...
      <el-table-column
        prop="socialSecurityCategoryDesc"
        label="社保类别"
        width="120"
        sortable="custom"
        show-overflow-tooltip>
      ...
      <el-table-column
        ...
        show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{scope.row.fixedValue}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="120">
        <template slot-scope="scope">
          <router-link :to="'/settings/social_Security/edit/'+scope.row.id">
...
<script>
  ...
  import { fetchList, fetchRemove, fetchCityList } from '@/api/socialSecurity'
    ...
    data() {
      return {
        ...
        listQuery: {
          ...
          cityCode: undefined,
          payFromId: undefined,
          //accountPropertyId: undefined,
          socialSecurityCategoryId: undefined,
