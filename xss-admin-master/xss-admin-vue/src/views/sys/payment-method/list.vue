<template>
  <div class="app-container">
    <!--<div class="filter-container">
      ...
      <router-link :to="'/sys/payment_method/add'">
    ...
    <el-table ref="multipleTable" :data="list" v-loading="listLoading" fit tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" @sort-change='sortChange'>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span>{{$t('paymentMethod.'+scope.row.method)}}</span>
        </template>
      </el-table-column>
      ...
      <!--<el-table-column align="center" label="操作" width="120">
        <template slot-scope="scope">
          <router-link :to="'/sys/payment_method/edit/'+scope.row.id">
...
<script>
  ...
  import { getPaymentMethodList,deletePaymentMethods } from '@/api/sys'
