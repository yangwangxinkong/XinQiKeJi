<template>
  <div class="app-container">
    ...
    <el-table :data="list"
    v-loading="listLoading" border fit highlight-current-row style="margin-top: 5px;width: 100%"
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        get(url.configList, this.listQuery).then(response => {
      ...
      handleDelte() {
        ...
        this.$confirm('删除无法恢复, 是否继续?', '提示', {
          ...
          get(url.configDelete, {ids:ids}).then(response => {
