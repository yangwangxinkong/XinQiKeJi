...
public final class FreemarkerUtils {
	...
	public static Template getTemplate(FreeMarkerConfigurer freeMarkerConfigurer, String template) throws IOException {
		return freeMarkerConfigurer.getConfiguration().getTemplate(template + FREEMARKER_SUFFIX);
	}
