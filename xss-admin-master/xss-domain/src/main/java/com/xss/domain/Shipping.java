...
public class Shipping extends BaseEntity {
	...
	public static final String[] DEFAULT_JSON_PARAMS = new String[]{"id", "sn", "shippingMethod", "deliveryCorpUrl", "deliveryCorpCode", "deliveryCorp", "trackingNo", "consignee"};
	...
	public JSONObject convertEntity(Object entity, String[] params){
		...
		jo.put("createDate", DateUtil.format(((Shipping) entity).getCreateDate(), "yyyy-MM-dd HH:mm:ss"));
		if(((Shipping) entity).getOrder() != null) {
			jo.put("orderSn", ((Shipping) entity).getOrder().getSn());
		} else {
			jo.put("orderSn", "");
		}
		return jo;
