...
public class Admin extends BaseEntity {
	...
	public static final String[] DEFAULT_JSON_PARAMS = new String[]{"id", "username", "email", "name", "openId", "department", "loginIp", "isEnabled", "isLocked"};
...
//	@Length(min = 4, max = 20)
	...
	public JSONObject convertEntity(Object entity, String[] params){
		...
		jo.put("createDate", DateUtil.format(admin.getCreateDate(), "yyyy-MM-dd HH:mm:ss"));
		if(admin.getLoginDate()!=null){
			jo.put("loginDate", DateUtil.format(admin.getLoginDate(), "yyyy-MM-dd HH:mm:ss"));
		}
		if(ArrayUtils.contains(params,"roles")){
