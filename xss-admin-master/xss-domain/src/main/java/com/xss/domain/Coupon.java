...
public class Coupon extends BaseEntity {
	...
	public static final String[] jsonProperties = {"id","name", "prefix","beginDate","endDate","minimumQuantity","maximumQuantity","minimumPrice","maximumPrice","priceExpression","isEnabled","isExchange","point","introduction"};

	public static final String[] PROPERTIES = {"id","name","prefix","beginDate","endDate","isEnabled"};
...
//		}
	...
	public JSONObject convertEntity(Object entity, String[] params){
		...
		JSONObject jo = super.convertEntity(coupon,jsonProperties);
		jo.put("createDate", DateUtil.format(coupon.getCreateDate()));
		jo.put("beginDate", DateUtil.format(coupon.getBeginDate(), "yyyy-MM-dd"));
		jo.put("endDate", DateUtil.format(coupon.getEndDate(), "yyyy-MM-dd"));
		return jo;
	}
