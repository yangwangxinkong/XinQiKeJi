  ...
  <div class="app-container">
    ...
    <el-table ref="multipleTable" :data="list" v-loading="listLoading" fit tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" @sort-change='sortChange'>
      ...
      <el-table-column align="center" label="操作" width="120">
        <template slot-scope="scope">
          <router-link :to="'/sys/role/edit/'+scope.row.id"  v-if="!scope.row.isSystem">
            <el-button type="primary" size="small" icon="el-icon-edit">编辑</el-button>
          </router-link>
          <el-button type="primary" size="small" icon="el-icon-edit" v-else disabled>编辑</el-button>
        </template>
      </el-table-column>
...
<script>
  ...
  import { getRoleList,deleteRoles } from '@/api/sys'
    ...
    methods: {
      ...
      handleDelte() {
        ...
        this.$confirm('删除无法恢复, 是否继续?', '提示', {
          ...
          deleteRoles({ids:ids}).then(response => {
