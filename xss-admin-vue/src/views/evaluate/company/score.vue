      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="评分人数：">
            {{companyInfo?companyInfo.scoreNum:0}}
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="评分平均数：">
            {{companyInfo?companyInfo.averageNum:0}}
          </el-form-item>
        </el-col>
      </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getScoreList() {
        this.listLoading = true
        var searchData={"pageable":this.listQuery,"scoreSearch":{"type":"company","objId":this.id}};
