<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.feeCategoryId" clearable :placeholder="$t('settings.feeCategorySelect')" class="filter-item">
        <el-option
      ...
      <el-select v-model="listQuery.payCategoryId" clearable :placeholder="$t('settings.payCategorySelect')" class="filter-item">
        <el-option
      ...
      <router-link :to="'/settings/service_fee/add'">
    ...
    <el-table ref="multipleTable" :data="list" v-loading="listLoading" fit tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" @sort-change='sortChange'>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span>{{scope.row.monthCount}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="120">
        <template slot-scope="scope">
          <router-link :to="'/settings/service_fee/edit/'+scope.row.id">
...
<script>
  ...
  import { fetchList, fetchRemove, fetchCityList } from '@/api/serviceFee'
  import url from '@/api/apiUrl'
  import { get } from '@/api/server'

  export default {
    name: 'serviceFeeTable',
    directives: {
      waves
    },
    data() {
